...
class SpotDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if spot == nil { // must have clicked "+" button to add a new spot
            spot = Spot() // conveniece initiallizer
        }
    ...
    @IBAction func saveButtonPressed(_ sender: UIBarButtonItem) {
        spot.saveData { success in // 'success' is the return value of saveData()
            if success {
